...
{
  public  class TraCuuLichGhiChuSoViewModel :BaseViewModel
    {
        #region "Field"
        DateTime _fromdate;
        DateTime _todate;
        ObservableCollection<TRACUULICHGHICHISOMODEL> _listTraCuu;
        ...
        public CustomerByTel SelectItem { get => _selectItem;
            set
            {
        ...
        public TraCuuLichGhiChuSoViewModel()
        {
            ...
            ListTraCuu = new ObservableCollection<TRACUULICHGHICHISOMODEL>();
